...
export default class App extends Component{
  ...
  render() {
    return (
      ...
      <NavBar/> 
      <Routes>  
        <Route exact path='/' element={<News key="general" pageSize={this.pageSize} country="in" category="general" bagColor="danger"/>}/>
        ...
        <Route exact path='/general'element={<News key="general" pageSize={this.pageSize} country="in" category="general" bagColor="success"/>} />
